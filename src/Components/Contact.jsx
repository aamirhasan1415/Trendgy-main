      ...
      <section className="container mx-auto p-6 bg-gray-100 rounded-lg shadow-lg min-h-screen flex flex-col">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p>kasba, ballia, Begusarai, Bihar, 851211</p>
            <p className="text-gray-900 mt-2">Email: aamirhasan2929@gmai.com</p>
            <p className="text-gray-900">Contact Here: (+91) 9798527832</p>
